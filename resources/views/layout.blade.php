...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav me-auto mb-2 mb-md-0">
                        <li class="nav-item"><a class="nav-link" href="{{ route('home') }}"><img src="/css/whiteberich.png" alt="" width="80" height="30" /></a></li>
                    ...
                    <li class="nav-item dropdown" style="padding-right: 2%;">
                        <a class="btn btn-outline-secondary me-md-2 dropdown-toggle" id="navbarDropdownMenuLink" aria-labelledby="navbarDropdownMenuLink" style="margin-top: 5px;"><b>{{ Auth::user()->name }}</b></a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="{{ route('logout') }}">Meu Perfil</a>
                            <a class="dropdown-item" href="{{ route('logout') }}">Logout</a>
                        </div>
                    </li>
                    @else
                    </ul class="justify-content-md-end">
                    <a class="btn btn-outline-secondary" type="submit" href="{{ route('login') }}"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
    ...
    <footer class="bg-dark text-center text-white">
        ...
        <div class="container p-4 pb-0">
            ...
            <section class="mb-4">
                <!-- Twitter -->
                <a class="btn" href="https://twitter.com/BerichFans" role="button" target="_blank">
                ...
                <!-- Linkedin -->
                <a class="btn" href="https://www.linkedin.com/in/fernando-caldas-50641824a/" role="button" target="_blank">
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
            © 2022 Copyright:
            <a class="text-white" href="#">Berich</a>
        </div>
        <!-- Copyright -->
    </footer>
