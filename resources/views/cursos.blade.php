                    ...
                    <div class="bck-owner text-start">
                        ...
                        <div class="row" style="padding: 10px;">
                            <div class="col">
                                ...
                                <a class="spanVar" href="{{ route ('posts.show', ['post' => $post->id]) }}">{{ $post->company }}</a>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <a class="spanVar" href="{{ route ('posts.show', ['post' => $post->id]) }}">{{ $post->location }}</a>
                            </div>
                            <div class="w-100"></div>
                            <div class="col">
                                <!--ICONE DO DINHEIRO-->
                                ...
                                <a class="spanVar" href="{{ route ('posts.show', ['post' => $post->id]) }}">{{ $post->salaryExpectation }}</a>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <a class="spanVar" href="{{ route ('posts.show', ['post' => $post->id]) }}">{{ $post->contract }}</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
